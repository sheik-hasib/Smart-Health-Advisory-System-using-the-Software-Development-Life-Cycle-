...
**Activity Level Multipliers**: Calories adjusted based on user- selected activity level. 
...
|**Test Case** |In**put (Height, Weight, Age, Gender, Activity)** |**Expected   Output** |**Actual   Output** |**Status** |
| :- | :- | :- | - | - |
...
1. Additional features like goal setting (weight gain/loss). 
...
|**Processing Module** |
| - |
|<p>BMI Calculation </p><p>BMR Calculation Caloric Needs and Suggestions </p>|
...
![](Aspose.Words.e82a6ad3-3ab1-47f7-9f47-21c8ddea358f.008.png)

**Input ![](Aspose.Words.e82a6ad3-3ab1-47f7-9f47-21c8ddea358f.009.png)![](Aspose.Words.e82a6ad3-3ab1-47f7-9f47-21c8ddea358f.010.png)**
...
**Output ![](Aspose.Words.e82a6ad3-3ab1-47f7-9f47-21c8ddea358f.011.png)![](Aspose.Words.e82a6ad3-3ab1-47f7-9f47-21c8ddea358f.012.png)**

`                   `BMI: 24.22                                                                                                                                                              

 

`                   `BMR: 1696.00                                                                                                                                                                                        ![](Aspose.Words.e82a6ad3-3ab1-47f7-9f47-21c8ddea358f.013.png).
...
Suggestion:  You are in a healthy weight range. Maintain your current lifestyle! 
